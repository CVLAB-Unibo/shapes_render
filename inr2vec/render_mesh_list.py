...
def main():
    ...
    path_input = path_base / "rec_mesh_manifold40/pred/"
    path_out = path_base / "rec_mesh_manifold40/renders_pred"
    ...
    for path in paths:
        ...
        # Rotation Object
        rot_object = (math.radians(0), math.radians(0), math.radians(150))
